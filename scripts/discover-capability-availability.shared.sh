...
exec "$PYTHON_COMMAND" "$SCRIPT_DIR/discover-capability-availability.py" --capability-registry "$REPO_ROOT/config/capabilities.json" --provider-registry "$REPO_ROOT/config/providers.json" "$@"
