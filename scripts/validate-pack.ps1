...
$requiredFiles = @(
    ...
    "config/github-alpha-usage-report-contract.json",
    ...
    "config/runtime-certification-sources.json",
    "config/model-coding-agent-qualification-policy.json",
    "config/model-coding-agent-qualification-result.json",
    ...
    "config/task-execution-admission-contract.json",
    "config/task-effect-journal-contract.json",
    ...
    "examples/fixtures/task-effect-journal-request.json",
    ...
    "scripts/generate-github-alpha-usage-report.py",
    "scripts/test-github-alpha-usage-report.py",
    "scripts/simulate-task-composition.py",
    "scripts/test-task-composition.py",
    "scripts/simulate-task-execution-admission.py",
    "scripts/test-task-execution-admission.py",
    "scripts/simulate-task-effect-journal.py",
    "scripts/test-task-effect-journal.py",
    "scripts/core-update-trust-handoff.py",
    "scripts/core-update-verifier-transition.py",
    ...
    "config/structured-tool-transport-contract.json",
    "config/wiki-sync.tsv",
    "config/wiki-navigation.tsv",
    ...
    "docs/release.md",
    "docs/alpha-usage-report.md",
    "docs/github-repository-policy.md",
    "docs/wiki-home.md",
    "docs/wiki-quick-start.md",
    "docs/wiki-using-haven42.md",
    "docs/wiki-model-selection.md",
    "docs/wiki-troubleshooting.md",
    "docs/wiki-image-setup.md",
    "docs/wiki-roadmap.md",
    "docs/wiki-evidence-summary.md",
    "docs/wiki-advanced-topics.md",
    "docs/wiki-project-information.md",
    ...
    "docs/runtime-version-certification.md",
    ...
    "scripts/discover-runtime-certification-candidates.py",
    "scripts/test-runtime-certification-candidates.py",
    ...
    "docs/structured-tool-transport-foundation.md",
    "scripts/evaluate-structured-tool-transport.py",
    "scripts/test-structured-tool-transport.py",
    "scripts/run-structured-tool-live-validation.py",
    "scripts/test-structured-tool-live-validation.py",
    "scripts/probe-linux-parser-isolation.py",
    "scripts/test-linux-parser-isolation-probe.py",
