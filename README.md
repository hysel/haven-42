...
| Product UI | Milestone 22 now has an agreed first-run experience, navigation contract, wireframes, a registry-backed nonvisual view model, 46 engine-side IPC cases, and 55 native-authority policy cases. Tauri 2/private IPC remains selected, but execution stays disabled and published dependency blockers still prevent a desktop runtime from shipping. |
