...
| Milestone 21: General-Purpose AI Assistant And Intent Routing | In progress | Repository-optional sessions, deterministic capability routing, a live-validated local text adapter, runtime provider discovery, and engineering workflow route plans are implemented; optional bounded LLM routing and image-provider admission remain. |
