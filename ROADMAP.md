...
| Milestone 26: Hardware-Adaptive Model Quantization | First live cell validated | The foundation is implemented, and one exact Linux/NVIDIA/Ollama trusted-artifact comparison now validates Q4_K_M over Q8_0 for the tested profile; broader platform and workload cells remain open. |
