...
6. Add Windows NVIDIA, Windows Intel, Windows AMD, and Apple Silicon paths only
   ...
   bounded manual Ollama provider-envelope run is complete; direct accelerator-specific llama.cpp tool-call cells and runtime integration remain open. A physical Intel Arc B580 supplies candidate-only Linux
