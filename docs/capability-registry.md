...
| --- | --- | --- | --- |
| `general.chat` | none | `configuration-required` | Future evidence-gated text provider |
| `content.write` | none | `configuration-required` | Future evidence-gated text provider and approved artifact path |
| `content.summarize` | none | `configuration-required` | Future evidence-gated text provider and approved artifact path |
