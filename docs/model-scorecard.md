...
| digest-pinned-13-model-corpus | Haven 42 Alpha 2 qualification harness | Ubuntu 26.04 LTS | exact-artifact-core-task-gate-and-30-minute-soak | local-endpoint | partial pass | 1 |
