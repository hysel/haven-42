...
The sample repository factory creates local, disposable repositories for validating prompts, agent surfaces, language guidance, and approved-write behavior without using private or customer repositories.
