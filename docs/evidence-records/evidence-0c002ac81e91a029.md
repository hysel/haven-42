# Granite 4.1 30B coding workflow screen

> Generated evidence page. The canonical machine-readable record is
> `evidence-0c002ac81e91a029` in `config/evidence-page-registry.json`.

## What this record says

API, read, review, and scoped edit passed, but the approved-write phase failed; no coding-agent admission or cross-surface inheritance is allowed.
