# Ornith 1.0 9B coding workflow screen

> Generated evidence page. The canonical machine-readable record is
> `evidence-fdfbebccf314f75a` in `config/evidence-page-registry.json`.

## What this record says

API, read, write, and scoped edit passed, but repository review failed; no coding-agent admission or cross-surface inheritance is allowed.
