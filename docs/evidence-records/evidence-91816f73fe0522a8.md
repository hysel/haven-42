...
> `evidence-91816f73fe0522a8` in `config/evidence-page-registry.json`.

## What this record says

Bounded supplied-fact retention and typed artifact checks passed; long-document quality is not claimed.
...
| Model | qwen3.5:9b |
| Operation | General Summarization |
