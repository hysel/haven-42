# Qwen 3.5 2B coding workflow screen

> Generated evidence page. The canonical machine-readable record is
> `evidence-3f07eddd1d3c4c51` in `config/evidence-page-registry.json`.

## What this record says

API, approved write, and scoped edit passed, but repository read and review failed; no coding-agent admission is allowed.
