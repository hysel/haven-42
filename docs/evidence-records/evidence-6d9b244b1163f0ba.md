# Alpha 2 managed lifecycle on Bazzite 44

> Generated evidence page. The canonical machine-readable record is
> `evidence-6d9b244b1163f0ba` in `config/evidence-page-registry.json`.

## What this record says

Fresh setup, exact identity, GPU inference, normal shutdown, process and port closure, zero-download reuse, and canonical-home marker-owned uninstall passed; packaged desktop repetition remains open.
