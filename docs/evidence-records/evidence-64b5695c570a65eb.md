# Alpha 2 managed lifecycle on Arch Linux rolling

> Generated evidence page. The canonical machine-readable record is
> `evidence-64b5695c570a65eb` in `config/evidence-page-registry.json`.

## What this record says

Fresh setup, exact identity, GPU inference, normal shutdown, process and port closure, zero-download reuse, and marker-owned uninstall passed through an explicit Bash launcher; packaged desktop repetition remains open.
