# Qwen 3.6 35B-A3B Q4 coding workflow screen

> Generated evidence page. The canonical machine-readable record is
> `evidence-993d371eb43c7b6d` in `config/evidence-page-registry.json`.

## What this record says

All generated-repository coding workflow gates passed on the exact dual-V100 profile; reliability, human review, editor surfaces, and automatic admission remain blocked.
