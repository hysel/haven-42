# LFM 2.5 8B-A1B coding workflow screen

> Generated evidence page. The canonical machine-readable record is
> `evidence-a108eefa61d6f8db` in `config/evidence-page-registry.json`.

## What this record says

Repository read passed, but API, review, approved write, and scoped edit failed; license review and all coding-agent admission gates remain open.
