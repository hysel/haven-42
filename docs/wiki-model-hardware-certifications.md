...
That required new evidence now exists for Gemma 3 1B and Phi 4 Mini on the
exact Ollama 0.32.13 Ubuntu/CUDA review profile above. It does not rewrite the
older Ollama 0.32.9 result or generalize to another runtime, operating system,
