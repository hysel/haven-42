...
- Recorded the successful clean hosted Windows, Linux, and macOS reproduction and main-only attestation of the three unsigned development archives for exact main commit `04baca39b26ec58c189a6ae21ea78b507444e9fa`; production, redistribution, signing, notarization, and later release-candidate gates remain open.
